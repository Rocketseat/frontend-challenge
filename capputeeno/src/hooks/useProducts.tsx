...
import { graphiQlQuerys, mapApiProductsToInternal } from '@/utils/graphi-ql'
import {
  Products,
  ProductsApi,
  ProductsFecthResponse,
} from '@/types/useProducts'
...
export function useProducts() {
  ...
  const internalResponse = mapApiProductsToInternal(response || [])

  const responseFilter = internalResponse?.filter((p) =>
